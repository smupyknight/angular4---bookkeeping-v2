...
function addNewDropdown( $compile, $parse ) {
	...
	output.link = function( scope, element, attrs ) {
		$( element ).wrap( '<div class="custom-dropdown"> </div>' );
		$( element ).parent().prepend( $compile( '<div class="selectize-input" style="padding: 0px !important;"> <input type="text" placeholder="' + attrs.placeholder + '" class="dropdown-input" data-ng-model="' + attrs.ngModel + '" style="width: 100%; padding: 8px 8px !important;"> </div>' )( scope ) );
